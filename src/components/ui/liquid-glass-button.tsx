  ...
  "group relative isolate inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold outline-none transition-[transform,box-shadow,background-color] duration-200 ease-out will-change-transform hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.97] disabled:pointer-events-none disabled:opacity-50 focus-visible:ring-[3px] focus-visible:ring-ring/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-[color-mix(in_oklab,var(--color-destructive)_12%,white)] text-destructive ring-1 ring-inset ring-[color-mix(in_oklab,var(--color-destructive)_28%,transparent)] backdrop-blur-xl hover:bg-[color-mix(in_oklab,var(--color-destructive)_18%,white)]",
